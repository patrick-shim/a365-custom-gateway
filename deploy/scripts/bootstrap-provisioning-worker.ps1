...
$TemplateFile = Join-Path $PSScriptRoot '..\bicep\provisioning-bootstrap.bicep'
$PreflightScript = Join-Path $PSScriptRoot 'test-provisioning-prerequisites.ps1'
$ApprovedBicepSources = [ordered]@{
    '..\bicep\provisioning-bootstrap.bicep' = '739F22CB142A1B90AF2BC691C0733294486F8FBAD930FBF85E10929F15A9F5F1'
    '..\bicep\modules\container-app-worker.bicep' = '9EB7D46C9F5FC2DC4DAD09C1EC7EC83780A5A54E905B7A6E4A8F55AE184EE2E1'
    '..\bicep\modules\key-vault.bicep' = '431AF5568A7169860FD2C9FC2FFE10A1E236E43B68C39D035FE666B64D8B3136'
    '..\bicep\modules\role-assignments-worker-bootstrap.bicep' = '2729DB609C3EE25620374826B5A7FCFBFEB89DC346F1F78C152D07E3BF37EF2F'
}
