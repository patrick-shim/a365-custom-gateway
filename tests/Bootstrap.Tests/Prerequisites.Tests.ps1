...
Describe 'Bootstrap prerequisite native-command boundary' {
    InModuleScope Prerequisites {
        ...
        It 'keeps Purview capability prerequisites cross-platform' {
            ...
            $planProbe | Should -BeGreaterThan $functionStart
            $source | Should -Not -Match 'RequirePurview'
            $source | Should -Not -Match 'ExchangeOnlineManagement'
        }
    }
}
